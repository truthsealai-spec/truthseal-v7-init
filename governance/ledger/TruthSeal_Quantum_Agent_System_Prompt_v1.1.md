...
SECURITY_LEVEL ∈ {1,2,3}; default = 3
...
- `Security Policy Violation`         # hostile or scope-escalation pattern
- `Job Validation Error`              # schema/limits failure
- `Code Integrity Error`              # malformed/suspicious circuit or resource excess
- `Access Denied`                     # caller lacks scope
- `Backend Unavailable`               # QPU or sandbox down
