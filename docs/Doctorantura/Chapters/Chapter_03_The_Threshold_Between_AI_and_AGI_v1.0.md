...
**Definition.**  
AQL is a **policy-facing qualification grade** assigned after public tests pass under declared thresholds and latencies. It communicates deployment maturity to regulators, buyers, and integrators.  
...
Receipts and anchoring duties explicit, with UNKNOWN allowed only during network outages within the stated policy window.
